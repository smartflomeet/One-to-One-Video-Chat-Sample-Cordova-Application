cordova.define("sfm-cordova-plugin.enxcordovaplugin", function(require, exports, module) {
...
var PLUGIN_NAME = 'EnxRtc';
  ...
  var EnxCordovaPlugin = {
    ...
    */
    ...
    /**
     * To enable logs of smartflomeet SDK.
    ...
    */
     ...
     */
     makeOutboundCall: function (number,callid,dialOptions) {
      ...
      sendDTMF :function(number,digits){
        var options = {};
        options.number=number;
        options.digits=digits
        exec(null,null,PLUGIN_NAME,"sendDTMF",[options])
   ...
   /**
    ...
    startLiveTranscriptionForRoom: function (language) {
     ...
     stopLiveTranscription: function () {
      ...
      startLiveRecording: function (json) {
          var options = {};
          options.json = json;
          exec(null, null, PLUGIN_NAME, 'startLiveRecording', [options]);
        },

     stopLiveRecording: function () {
          var options = {};
          exec(null, null, PLUGIN_NAME, 'stopLiveRecording', [options]);
        },

        requestSharePermission: function (enxPubType) {
               var options = {};
               options.enxPubType = enxPubType;
               exec(null, null, PLUGIN_NAME, 'requestSharePermission', [options]);
                },

        cancelSharePermission: function (enxPubType) {
               var options = {};
               options.enxPubType = enxPubType;
               exec(null, null, PLUGIN_NAME, 'cancelSharePermission', [options]);
            },

       setSharePermissionMode: function (enxPubType,enxPubMode) {
               var options = {};
               options.enxPubType = enxPubType;
               options.enxPubMode = enxPubMode;
               exec(null, null, PLUGIN_NAME, 'setSharePermissionMode', [options]);

                                },
     grantSharePermission: function (enxPubType,clientId) {
         var options = {};
        options.enxPubType = enxPubType;
        options.clientId = clientId;
        exec(null, null, PLUGIN_NAME, 'grantSharePermission', [options]);
            },

      denySharePermission: function (enxPubType,clientId) {
            var options = {};
           options.enxPubType = enxPubType;
           options.clientId = clientId;
           exec(null, null, PLUGIN_NAME, 'denySharePermission', [options]);
               },

     releaseSharePermission: function (enxPubType,clientId) {
           var options = {};
          options.enxPubType = enxPubType;
          options.clientId = clientId;
          exec(null, null, PLUGIN_NAME, 'releaseSharePermission', [options]);
              },

      getSharePermissions: function () {
            var options = {};
           exec(null, null, PLUGIN_NAME, 'getSharePermissions', [options]);
               },
