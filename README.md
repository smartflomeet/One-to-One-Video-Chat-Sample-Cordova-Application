# Getting Started with SmartFloMeet Cordova Integration: Step-by-Step Guide and Configuration

This application exemplifies the seamless integration of SmartFloMeet in a Cordova environment for 1-to-1 video chats. It serves as a hands-on guide, offering detailed insights into the setup, configuration, and core functionalities. Moreover, it assists developers in grasping the nuances of real-time video communication within a Cordova framework.
...
* [Clone or download this Repository](https://github.com/smartflomeet/One-to-One-Video-Chat-Sample-Cordova-Application.git)


#### 1.1.3 Sample App Server 

* [Clone or download this Repository](https://github.com/smartflomeet/Sample-Web-App-1to1-RTC.git) & follow the steps further 
...
* Go to index.js and change the following:
    ...
    /*Your webservice host URL, Keet the defined host when kTry = true */
          var kBasedURL = "https://demo.smartflomeet.ttns.in/";
...
#### 1.1.5 To install the SmartFloMeet Cordova plugin

* Run the following command in the root of your project:
    
    `cordova plugin add sfm-cordova-plugin@latest`

#### 1.1.6 How to set up cordova plugin Android/IOS

### Android
    
After adding Cordova SmartFloMeet plugin
### Step 1. 
...
### IOS
        ...
        After adding Cordova SmartFloMeet plugin please add ios project as below command
        
        cordova platform add ios
        
        It will install all dependency sfm library through Pod. After that go to your iOS project folder and open your xcode , set up your certificate and then build the app either command line or through xcode. 
